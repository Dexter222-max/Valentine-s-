...
<head>
  ...
  <meta property="og:description" content="Will you be my Valentine?">
  <meta property="og:site_name" content="Will you be my Valentine?">
  <meta property="og:image:alt" content="Will you be my Valentine?">

  <!-- Twitter Meta Tags -->
  <meta property="twitter:url" content="https://Dexter-223.github.io/valentine/valentine.html?name=Dan">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Will you be my Valentine?">
  <meta name="twitter:description" content="Will you be my Valentine?">
  <meta name="twitter:image" content="https://raw.githubusercontent.com/Dexter-222/valentine/refs/heads/main/img/header.png">
...
<body>
  ...
  <main class="card">
    <div class="art-container">
      <img src="img/bunnies.svg" alt="Bunnies" class="art">
    </div>
    ...
    <div class="hint" id="hint">Even 'No' is whispering 'Yes'…🥰</div>

    <section class="result" id="result">
      <h2 id="resultText">YAY!🎉</h2>
      <img
        class="fireworks"
  ...
  <script>
    ...
    (async () => {
      ...
      question.textContent = nameParam ? t.question.replace("{name}", nameParam) : t.title;
      yesBtn.textContent = t.yes;
      noBtn.textContent = t.no;
      hint.innerHTML = parseMarkdown(t.hint);
      document.getElementById("resultText").textContent = t.yay;
      ...
      function fullScreenConfetti() {
        burst({ particleCount: 180, spread: 160, startVelocity: 65, origin: { x: 0.5, y: 0.5 } });

        setTimeout(() => {
          burst({ particleCount: 90, angle: 60, spread: 70, origin: { x: 0, y: 0.55 } });
          burst({ particleCount: 90, angle: 120, spread: 70, origin: { x: 1, y: 0.55 } });
        }, 160);
        ...
        (function frame() {
          const yBase = ys[(Math.random() * ys.length) | 0];
          burst({
            particleCount: 10,
            spread: 95,
            startVelocity: 45,
            origin: { x: Math.random(), y: yBase + (Math.random() - 0.5) * 0.18 }
          });
          if (Date.now() < end) requestAnimationFrame(frame);
        })();

        setTimeout(() => {
          burst({ particleCount: 260, spread: 200, startVelocity: 70, origin: { x: 0.5, y: 0.42 } });
        }, 900);
      }
      ...
      yesBtn.addEventListener("click", () => {
        document.querySelector(".art-container").style.display = "none";
